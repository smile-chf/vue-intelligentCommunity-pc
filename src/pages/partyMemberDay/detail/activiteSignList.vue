...
<script>
    export default {
        ...
        props: ['id'],
        created() {
            this.axios.get('/intelligentCommunity/manage/partyEventDay/partyEventDayPunchInList?pageSize=' + this.pageSize1 + '&pageNum=' + this.pageNum1 + '&id=' + this.id).then(data => {
