<template>
    <div class="wrap replay">
        ...
        <please_leave_detail :id="id" v-if="isshow" @goback="goback"></please_leave_detail>
...
<script>
    import please_leave_detail from "./detail/please_leave_detail";
    export default {
        name: "please_leave",
        data() {
            return {
        ...
        methods: {
            ...
            //搜索
            Onsearch(){
                this.axios.post('/intelligentCommunity/manage/party/queryAll?pageSize='+this.pageSize+'&pageNum='+this.pageNum,{
            ...
            opendelete(){
                ...
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    this.axios({
                        method: 'post',
                        url:'/intelligentCommunity/manage/party/conference/delAskLeave',
                        data:this.idArr
                    })
                        .then(data => {
                            if (data.data.code === 200) {
            ...
            passsure() {
                ...
                this.axios.post('/intelligentCommunity/manage/party/conference/updateAskLeave', {
                    id: this.passId,
                    status: this.type,
            ...
            getlist() {
                this.loading = true;
                this.axios
                    .post('/intelligentCommunity/manage/party/queryAll?pageSize='+this.pageSize+'&pageNum='+this.pageNum,{
                        memberName:'',
                        createTime:'',
                        subject:'',
                        status:'',
