    ...
    export default {
        ...
        methods:{
            ...
            opendetail(id){
                ...
                this.classId=id;
                this.isshow=true;
                this.axios.get('/intelligentCommunity/manage/activityProject/getProjectTypeDetail/'+id).then(res=>{
            ...
            //确定
                ...
                if(this.isAdd==0){
                    // 修改
                    this.axios.post('/intelligentCommunity/manage/activityProject/saveProjectType',{
                        id:this.classId,
                        name:this.form.name,
            ...
            opendelete() {
                ...
                this.$confirm('此操作将永久删除该数据, 是否继续?', '提示', {
                    ...
                    this.axios({
                        method: 'post',
                        url: '/intelligentCommunity/manage/activityProject/delProjectType',
                        data: this.idArr
                    })
                        .then(data => {
            ...
            getlist() {
                this.loading = true;
                this.axios
                    .get("/intelligentCommunity/manage/activityProject/getProjectTypeList", {
                        params: {
